  ...
  return (
    <footer className="w-screen bg-[#5542ff] py-4 text-black">
      <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row">
        <p className="uppercase font-zentry font-black text-xl text-center md:text-left">
        ...
        <a
          href="#privacy-policy"
          className="text-center uppercase font-zentry font-black text-xl hover:underline md:text-right"
        >
          Privacy Policy
        </a>
      </div>
